...
import { getAppFeedbacksService } from 'common/services/feedback';
...
export const FeedbackList = () => {
  ...
  const { projectId, loading: projectLoading, project } = useContext(ProjectContext);
  ...
  useEffect(() => {
    if (!projectLoading) {
      ...
      getAppFeedbacksService(project.id, {
