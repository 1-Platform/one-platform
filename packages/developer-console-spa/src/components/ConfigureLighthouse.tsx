...
const ConfigureLighthouse = ( props: any ) => {
  ...
  const opLighthouseDocLink = window.location.origin + '/get-started/docs/apps/internal/lighthouse';
                ...
                <Card isRounded>
                  <CardBody>
                    <EmptyState>
                      ...
                      <EmptyStateSecondaryActions>
                        <Button variant="link" component="a" target="_blank" rel="noopener noreferrer" href={ lighthouseDocLink }>Learn more</Button>
                      </EmptyStateSecondaryActions>
                    </EmptyState>
                  </CardBody>
                </Card>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardTitle className="success-header-fontSize">
                      <ion-icon name="checkmark-done-circle-outline" class="pf-u-success-color-200"></ion-icon>
                      You are all set!
                    </CardTitle>
                  </CardHeader>
                  <CardBody>
                    <Flex>
                      <FlexItem align={ { default: 'alignRight' } }>
                        <Button variant="link" component="a" target="_blank" rel="noopener noreferrer" href={ opLighthouseDocLink }>Learn More</Button>
                      </FlexItem>
                      <FlexItem>
                        <Button
                          variant="link"
    ...
    ci: {
      ...
      assert: {
        preset: 'lighthouse:recommended'
                      ...
                      <br />
                      <p>For Advanced users who'd prefer to use CLI flags or keep the configuration file in another location, refer to the <a href={ lighthouseConfigDocLink } rel="noopener noreferrer" target="_blank">docs</a>.</p>
                    </CardBody>
                  </CardExpandableContent>
                </Card>
              </StackItem>
      ...
      { isModalOpen &&
        <Modal
          ...
          titleIconVariant={ showConfirmation ? () => <ion-icon name="checkmark-circle-outline"></ion-icon> : undefined }
          isOpen={ isModalOpen }
          onClose={ handleModalToggle }
          onEscapePress={ handleModalToggle }>
          { !showConfirmation ? <>
            <div>
            You can link your app with a project on One Platform Lighthouse CI server<Button variant="link" target="_blank" rel="noopener noreferrer" href={ lighthouseDocLink }>Learn more</Button>
            </div>
