...
context("Home Page Tests", () => {
  ...
  it("Check whether view more analytics link is visible", () => {
    cy.contains("View more Analytics")
      .should("be.visible")
      .should("have.attr", "href", "/console");
  });
  ...
  it("Check whether Feedback heading is visible", () => {
    cy.xpath(
      "//h3[@class='services__service-title'][normalize-space()='Feedback']"
    ).should("be.visible");
  });
  ...
  it("Check whether Notification heading is visible", () => {
    cy.xpath(
      "//h3[@class='services__service-title' and contains(text(),'Notification')]",
      { force: true }
    ).should("be.visible");
  });
  ...
  it("Check whether User group heading is visible", () => {
    cy.xpath(
      "//h3[@class='services__service-title' and contains(text(),'User Group')]",
      { force: true }
    ).should("be.visible");
  });
  ...
  it("Check whether Search heading is visible", () => {
    cy.xpath(
      "//h3[@class='services__service-title' and contains(text(),'Search')]",
      { force: true }
    ).should("be.visible");
  });
  ...
  it("Check the Header at the bottom is visible", () => {
    cy.get(".deploy__info-title").should(
      "contain.text",
      "Deploy your app on One Platform"
    );
  });
  ...
  it("Check the links in footer section", () => {
    footerPage
      .footerLinks()
      .shadow()
      .find("a[name='One Platform on The Source']")
      .should("be.visible");
    footerPage
      .footerLinks()
      .shadow()
    ...
    footerPage
      ...
      .shadow()
      .find(
        "a[href='https://source.redhat.com/groups/public/one_platform/sample_channel']"
      )
      .should("be.visible");
    footerPage
      .footerLinks()
      .shadow()
      .find("a[href='https://access.redhat.com/']")
      .should("be.visible");
    footerPage
      .footerLinks()
      .shadow()
      .find("a[href='https://connect.redhat.com/']")
      .should("be.visible");
    footerPage
      .footerLinks()
      .shadow()
      .find("a[href='https://catalog.redhat.com/']")
      .should("be.visible");
    footerPage
      .footerLinks()
      .shadow()
    ...
    footerPage
      .footerLinks()
      .shadow()
      .find('a[href="mailto:one-platform@redhat.com"]')
      .should("be.visible");
    footerPage
      .footerLinks()
      .shadow()
      .find('a[href="https://github.com/1-platform/one-platform"]')
      .should("be.visible");
  });
  it("Check redirection from Get Started Button in bottom", () => {
    cy.xpath('//a[@class="deploy__get-started"]')
      .should("be.visible")
